...
export function registerOverlayTools(ctx: Context, rt: GeoToolRuntime): void {
  ...
  ctx.tools.register(defineTool({
    ...
    execute(args, exec) {
      ...
      return Promise.resolve(pushResult('裁剪', opClip(g.a, g.b), `${g.a.name} × ${g.b.name}`))
    },
  }))
  ...
  ctx.tools.register(defineTool({
    ...
    execute(args, exec) {
      ...
      if (!('a' in g)) return Promise.resolve(g)
      return Promise.resolve(pushResult('求交', opIntersect(g.a, g.b), `${g.a.name} ∩ ${g.b.name}`))
    },
  }))
  ...
  ctx.tools.register(defineTool({
    ...
    execute(args, exec) {
      ...
      const g = overlayGuard(resolve, args, args.overlay)
      if (!('a' in g)) return Promise.resolve(g)
      return Promise.resolve(pushResult('差集', opDifference(g.a, g.b), `${g.a.name} - ${g.b.name}`))
    },
  }))
  ...
  ctx.tools.register(defineTool({
    ...
    execute(args, exec) {
      ...
      const g = overlayGuard(resolve, { layer: args.layerA }, args.layerB)
      if (!('a' in g)) return Promise.resolve(g)
      return Promise.resolve(pushResult('并集', opUnion(g.a, g.b), `${g.a.name} ∪ ${g.b.name}`))
    },
  }))
}
